...
typedef struct tagDvcMiscBits
{
  ...
  unsigned int nTempWarn :1;
  unsigned int ucRes0 :6;
  unsigned int ucRes1 :4;
  unsigned int nMainsGlitch :1;
  unsigned int nPSUSafeMode :1;
  unsigned int nCheckACMains :1;
  unsigned int nPALP51 :1;
  unsigned int nPTL :1;
  unsigned int nATL :1;
  unsigned int nBEL :1;
  unsigned int nUVL :1;
  unsigned int nPowerProtect :1;
  unsigned int nMainsHighFaultPeak :1;
  unsigned int nMainsHighFault :1;
  unsigned int nMainsLowFault :1;
} DvcMiscBits;
